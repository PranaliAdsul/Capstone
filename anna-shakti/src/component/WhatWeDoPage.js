...
function WhatWeDoPage() {
    return ( <
        ...
        li > Improved Food Security: Our app helps to improve food security
        ...
        li > Volunteer Engagement: Our app provides opportunities
        for volunteers to get involved in our efforts to fight hunger and food waste.Volunteers can help with food collection, distribution, and other activities, and we provide training and support to ensure that everyone has a positive and meaningful experience. < /li> <
        ...
        li > Data Analysis: Our app collects data on food waste and distribution, which we use to optimize our operations and improve our impact.By analyzing this data, we can identify trends and opportunities
        for improvement, and ensure that surplus food is distributed as effectively as possible. < /li> <
        /div>
    );
}
